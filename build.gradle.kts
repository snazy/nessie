...
val versionErrorProneAnnotations = "2.12.1"
val versionErrorProneCore = "2.13.1"
val versionErrorProneSlf4j = "0.1.12"
val versionGatling = "3.7.6"
val versionGuava = "31.1-jre"
val versionGoogleJavaFormat = "1.15.0"
val versionGraalSvm = "22.0.0.2"
val versionH2 = "2.1.210"
...
val versionJaxrsApi21Spec = "2.0.1.Final"
...
val versionMongodbDriverSync = "4.3.4"
...
val versionPostgres = "42.3.3"
val versionProtobuf = "3.21.1"
val versionReactor = "2020.0.19"
val versionRestAssured = "5.1.0"
...
val buildToolIntegrationGradle by
  tasks.registering {
    ...
    dependsOn(gradle.includedBuild("build-tools-integration-tests").task(":test"))
  }

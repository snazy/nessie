...
dependencies {
  constraints {
    ...
    api(project(":nessie-jackson-protobuf"))
    api(project(":nessie-jackson-protobuf-annotations"))
    api(project(":nessie-jackson-protobuf-fixture"))
    api(project(":nessie-jackson-protobuf-fixture-proto"))

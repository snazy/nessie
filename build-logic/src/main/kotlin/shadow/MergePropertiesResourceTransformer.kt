...
open class MergePropertiesResourceTransformer @Inject constructor(objectFactory: ObjectFactory) :
  WithPatternFilterable(), ResourceTransformer {
  ...
  @get:Nested val ignoreDuplicates: PatternFilterable = ignoreDuplicatesFor

...
public final class MetricsVersionStore<VALUE, METADATA> implements VersionStore<VALUE, METADATA> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(MetricsVersionStore.class);
   ...
   */
  public MetricsVersionStore(VersionStore<VALUE, METADATA> delegate, Map<String, String> metricsCommonTags, MeterRegistry registry) {
    ...
    LOGGER.info("VersionStore emits Micrometer metric information");
  }

  public MetricsVersionStore(VersionStore<VALUE, METADATA> delegate, Map<String, String> metricsCommonTags) {
    this(delegate, metricsCommonTags, Metrics.globalRegistry);
  }

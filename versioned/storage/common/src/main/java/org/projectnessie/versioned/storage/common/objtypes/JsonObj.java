...
public interface JsonObj extends Obj {
   ...
   */
  static JsonObj json(ObjId id, long created, @Nonnull Object bean) {
    return json(id, created, bean.getClass(), bean);
  }
   ...
   */
  static JsonObj json(ObjId id, long created, Class<?> type, @Nullable Object bean) {
    return json(id, created, type.getName(), bean);
  }
   ...
   */
  static JsonObj json(ObjId id, long created, String type, @Nullable Object bean) {
